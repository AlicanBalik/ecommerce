...
namespace IdentitySample.Models
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        public async Task SendAsync(IdentityMessage message)
        {
            ...
            msg.From = new MailAddress("noreply@riba.com");
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential("steamkoreport@gmail.com", "Alicanbalik1");
    ...
    public class ApplicationDbInitializer : CreateDatabaseIfNotExists<ApplicationDbContext>
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db)
        {
            ...
            const string name = "noob@nobnooob.com";
            const string password = "dcjhr7dmin@123456";
